...
<body>
	<header class="header px-4">
		<a href="/" class="header__logo">BIFK</a>
	...
	<nav class="sidebar">
		<div class="sidebar__content ">
			...
			<ul class="sidebar__nav">
				<li class="sidebar__item">
					<a href="/users" class="sidebar__link {{ Request::is('users*') ? 'sidebar__link_active' : '' }}">
						<i class="uil uil-clipboard-notes sidebar__icon"></i>
						<span>Список</span>
					</a>
				</li>
				<li class="sidebar__item">
					<a href="/register" class="sidebar__link {{ Request::is('register*') ? 'sidebar__link_active' : '' }}">
			...
			<ul class="sidebar__nav">
				<li class="sidebar__item">
					<a href="/list-voting" class="sidebar__link {{ Request::is('list-voting*') ? 'sidebar__link_active' : '' }}">
						<i class="uil uil-clipboard-notes sidebar__icon"></i>
						<span>Список</span>
					</a>
				</li>
				<li class="sidebar__item">
					<a href="/create-voting" class="sidebar__link {{ Request::is('create-voting*') ? 'sidebar__link_active' : '' }}">
