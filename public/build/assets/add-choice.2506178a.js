const i=document.querySelector(".btn-add-choice");i.addEventListener("click",function(){const e=document.querySelectorAll(".choice"),t=e[e.length-1],c=Number(e[e.length-1].dataset.choiceNumber),l=`
        ...
        </div>`;t.insertAdjacentHTML("afterend",l)});
